...
public class ChangeEmployeepass extends Frame implements ActionListener{
	private Frame parent;
	private int Count=0;
	private Adminpanel opp;
	public TextField tf[];
	public ChangeEmployeepass()
	{}
	    public ChangeEmployeepass(Adminpanel oll){
	...
	public void actionPerformed(ActionEvent ae){
		...
		String q="UPDATE  employee SET EPassword =('"+EPassword+"') WHERE E_id =('"+E_id+"')";
